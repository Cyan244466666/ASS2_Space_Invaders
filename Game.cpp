...
void Game::UpdateGame()
{
	...
	if (player.GetHasShot() == true && shootingDelay > 2.0f)
	{
	...
	alienShootingDelay += (1.7f * deltaTime);
...
void Game::GenerateOutput()
{
	...
	SDL_Rect topBarrier
	{
		barrierTop.GetPosX(),
		barrierTop.GetPosY(),
		barrierTop.GetScaleX(),
		barrierTop.GetScaleY()
	};
	SDL_Rect bottomBarrier
	{
		barrierBottom.GetPosX(),
		barrierBottom.GetPosY(),
		barrierBottom.GetScaleX(),
		barrierBottom.GetScaleY()
	};
	SDL_Rect rightBarrier
	{
		barrierRight.GetPosX(),
		barrierRight.GetPosY(),
		barrierRight.GetScaleX(),
		barrierRight.GetScaleY()
	};
	SDL_Rect leftBarrier
	{
		barrierLeft.GetPosX(),
		barrierLeft.GetPosY(),
		barrierLeft.GetScaleX(),
		barrierLeft.GetScaleY()
	};
	
	// Fill the barrier rects:
	SDL_RenderFillRect(m_Renderer, &topBarrier);
	SDL_RenderFillRect(m_Renderer, &bottomBarrier);
	SDL_RenderFillRect(m_Renderer, &rightBarrier);
	SDL_RenderFillRect(m_Renderer, &leftBarrier);
	//------------------------------------------
